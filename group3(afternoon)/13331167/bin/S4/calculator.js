...
(function(){
  $(function(){
    var bubbles, bar, button, icon, list, clickOnBubble, showNumber, changeState, allNumberGot, addUp, init, generateRandomList, showRandomList, robot;
    ...
    robot = function(randomList, index){
      var certainBubble;
