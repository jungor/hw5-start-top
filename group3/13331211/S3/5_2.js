...
(function(){
  ...
  HOW TO USE LSP??
  	...
  	CALLBACK->
  */
  var robotBoot, robotStart, robotClick, setUnvisibleAllUnreads, addClickListenerForAllLittleButtons, setUnvisible, setVisible, getRan, checkAndSet, clickListener, enable, disable, disableBigBubble, bubbleListener, enableBigBubble, setWaitingStyle;
  ...
  getRan = function(red, grey){
    $.get('/?random=' + Math.random(), function(data, status){
      $(red).html(data);
