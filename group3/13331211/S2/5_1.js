...
(function(){
  ...
  HOW TO USE LSP??
  	...
  	CALLBACK->
  */
  var robotBoot, robotStart, robotClick, setUnvisibleAllUnreads, addClickListenerForAllLittleButtons, setUnvisible, setVisible, getRan, checkAndSetAndContinueClick, clickListener, enable, disable, disableBigBubble, bubbleListener, enableBigBubble, setWaitingStyle;
  ...
  getRan = function(red, grey, n){
    $.get('/', function(data, status){
      $(red).html(data);
      checkAndSetAndContinueClick(red, grey, n);
    });
  ...
  checkAndSetAndContinueClick = function(red, grey, n){
