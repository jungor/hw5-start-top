...
(function(){
  var Button, displayMassage, initAllButtons, initBubble, resetWhenLeaveButton, reset, robot, calculator;
  Button = (function(){
    ...
    prototype.successOrFail = function(number){
      ...
      if (isSuccess = Math.random() > this.constructor.FAILRATE) {
        return this.callBackFunc(this.goodMassage, number);
      } else {
  ...
  robot = {
    ...
    nextClick: function(){
      if (this.index === orderS.length) {
        ...
        this.buttons[this.orderS[this.index++]].click();
      }
    }
  };
  calculator = {
