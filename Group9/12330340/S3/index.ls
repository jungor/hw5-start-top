class Button
  ...
  fetch-and-show: !~>
    ...
    @ajax.done (msg) !~> number = msg; @show-number number; @done!; calculator.add number; @@@enable-others @; bubble-click!; if robot.current == robot.sequence.length then robot.click-button!
