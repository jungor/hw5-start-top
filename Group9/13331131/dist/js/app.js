...
(function(){
  ...
  Button = (function(){
    ...
    prototype.addListener = function(){
      ...
      this.btn.on('click', function(e){
        if (this$.getState() === 'init' && constructor.status !== 'busy') {
  ...
  Robot = (function(){
    ...
    prototype.addListener = function(){
      ...
      this.opts.btn.on('click', function(e){
        if (this$.state !== 'busy') {
          ...
          case 'shunxu':
            constructor.orderNumber = [0, 1, 2, 3, 4];
            break;
          case 'bingxing':
            constructor.shuffle();
            break;
    ...
    prototype.clickFirst = function(){
      $(this.opts.buttons[constructor.orderNumber[this.current]]).click();
      this.activate = true;
    };
    prototype.clickNextBtn = function(){
      $(this.opts.buttons[constructor.orderNumber[++this.current]]).click();
    };
  ...
  $(function(){
    ...
    cm = new CircleMenu(opts, function(){
      if (!rob.activate) {
        return;
      }
      if (rob.current === 4) {
