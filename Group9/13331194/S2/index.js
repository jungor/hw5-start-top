...
(function(){
  var Button, allButtonsAbleToBeClickedToFetchNumber, buttonsInit, bubbleAbleToBeClickedToGetSum, getButtonsSum, addResettingWhenLeavingApb, reset, setBubbleAbleToBeClicked, bubbleInit, S1WaitUserClick, robot, S2RobotClickButtonsFromAToEAndThenClickBubble;
  $(function(){
    ...
    robot.initial();
    S1WaitUserClick();
    return S2RobotClickButtonsFromAToEAndThenClickBubble();
  });
  Button = (function(){
