...
(function(){
  var addClickingToFetchNumbersToAllButtons, addClickingToCalculateResultToTheBubble, addResettingWhenLeaveApb, clickToFetchNumber, disableOtherButtons, enableOtherButtons, system, robot, robotGenerateARandomOrderAndThenClick;
  $(function(){
    system.initial();
    robot.initial();
  ...
  clickToFetchNumber = function(thisButton, next){
    if (!system.buttons_request[thisButton.attr("title")] && system.getRequestLock()) {
      ...
      system.buttons_request[thisButton.attr("title")] = $.get('http://localhost:3000/S4/', function(number, result){
