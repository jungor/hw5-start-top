...
(function(){
  var addClickingToFetchNumbersToAllButtons, addClickingToCalculateResultToTheBubble, addResettingWhenLeaveApb, clickToFetchNumber, disableOtherButtons, enableOtherButtons, system;
  $(function(){
    system.initial();
  ...
  clickToFetchNumber = function(thisButton){
    if (!system.buttons_request[thisButton.attr("title")] && system.getRequestLock()) {
      ...
      system.buttons_request[thisButton.attr("title")] = $.get('http://localhost:3000/S1/', function(number, result){
