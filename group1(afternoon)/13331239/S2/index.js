...
(function() {
  ...
  simulateRobert = function() {
    ...
    buttons = $$('button');
    $('clickBar').disabled = 1;
    return getRandomNunber(buttons, buttons[0], function() {
      return getRandomNunber(buttons, buttons[1], function() {
        return getRandomNunber(buttons, buttons[2], function() {
          return getRandomNunber(buttons, buttons[3], function() {
            return getRandomNunber(buttons, buttons[4], function() {
              return calculateSum();
            });
          });
        });
