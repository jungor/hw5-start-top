...
(function() {
  var $, $$, calculateSum, callback, connectServer, disableOtherButtons, enableOtherButtons, everyButtonClick, getRandomNunber, ifActivateBigButton, resetCalculator, simulateRobert;
  ...
  simulateRobert = function() {
    ...
    for (i = 0, len = buttons.length; i < len; i++) {
      item = buttons[i];
      results.push(getRandomNunber(buttons, item));
    }
    return results;
  };
  ...
  resetCalculator = function() {
    var at_plus, bigButton, buttons, i, item, len, results;
    buttons = $$('button');
    bigButton = $('big-bar');
    at_plus = $('clickBar');
    bigButton.disabled = 1;
