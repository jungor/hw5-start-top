...
(function(){
  var autoRobot, fiveDragon, enableAtPlus, clearAll, boomAddClick, liAddClick, liGetNumber, disableOtherLi, callback, nextClick, enableBoomClick, enableOtherLi;
  ...
  enableBoomClick = function(){
    var unreads, success, i$, len$, item, atplus, icon_, unread_, sum, show;
