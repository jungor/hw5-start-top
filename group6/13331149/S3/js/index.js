...
(function(){
  ...
  Button = (function(){
    ...
    state = void 8;
    button = void 8;
    function Button(button, successInfo, faildInf){
      var this$ = this;
      this.button = button;
      this.successInfo = successInfo;
      this.faildInf = faildInf;
      this.state = 'enabled';
    ...
    prototype.getNumberAndShowIt = function(){
      var this$ = this;
      $.get('/?random=' + Math.random(), function(number, result){
        this$.done();
  ...
  atPlusButton = (function(){
    ...
    prototype.clickAllButton = function(){
      var i$, ref$, len$;
      for (i$ = 0, len$ = (ref$ = this.buttons).length; i$ < len$; ++i$) {
        (fn$.call(this, ref$[i$]));
      }
  ...
  initAllButtons = function(){
    ...
    return controlRing = new ControlRing($('#control-ring .button'), successInfos, faildInfos);
  };
