...
var data, GetRandomNumber, Check, RandomOrder, Presetting, click_next, checkIfSuccess, bubbleHandler, aHandler, bHandler, cHandler, dHandler, eHandler, Robot, Resetting;
$(function(){
  Resetting();
  Presetting();
});
...
/* 5个按钮的控制函数 */
aHandler = function(){
  var buttons, r_numbers, ring_numbers, r, xmlhttp, can, i$, l;
  if (data.click_num < 5) {
    buttons = document.getElementsByTagName("ul");
    r_numbers = buttons[1].getElementsByTagName("li");
    ring_numbers = buttons[0].getElementsByTagName("li");
