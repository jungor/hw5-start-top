...
(function(){
  var xmlhttpreq, Button, clickButtonToGetRandomNumber, clickBubbleToCalculateSum, resetWhenLeavingApb, resetAll, robot, clickAtPlus;
  xmlhttpreq = null;
  Button = (function(){
  ...
  robot = {
    ...
    showSequence: function(){
      this.bubble.find('.sequence').text(this.sequence.join(' '));
    },
    clickNext: function(){
      var nextIndex;
      if (this.index === this.sequence.length) {
        ...
        nextIndex = this.sequence[this.index++].charCodeAt() - 'A'.charCodeAt();
