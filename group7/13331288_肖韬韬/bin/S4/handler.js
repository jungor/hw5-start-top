...
(function(){
  var Button, calculator, addClickingEventsToAllButtons, addClickingEventsToBubble, addResettingEventsWhenLeave, robot, s4Robot;
  Button = (function(){
  ...
  s4Robot = function(){
    $('#bottom-positioner').click(function(){
      robot.shuffleOrder();
      robot.showOrder();
      robot.clickNext();
    });
