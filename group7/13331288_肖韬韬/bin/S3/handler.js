...
(function(){
  var Button, calculator, addClickingEventsToAllButtons, addClickingEventsToBubble, addResettingEventsWhenLeave, robot, s3Robot;
  Button = (function(){
    ...
    prototype.showResultAndMakeOtherButtonsActive = function(){
      var this$ = this;
      $.get('/key=' + Math.random().toString(), function(number, result){
        this$.done();
