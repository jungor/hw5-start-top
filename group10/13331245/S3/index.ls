class Button
	...
	fetch-number-and-show: !-> $.get '../?random='+Math.random(), (number, result)!~>
		@done!
...
robot = 
	...
	click-bubble: !->
		@cursor++
		@bubble.click! if @cursor is @sequence.length
...
s3-robot-click-buttons-at-the-same-time-then-click-bubble = !-> $ '.apb' .click !-> robot.click-at-the-same-time!

$ ->
	robot.initial!
	add-clicking-to-fetch-numbers-to-all-buttons !-> robot.click-bubble!
	add-clicking-to-calculate-result-to-the-bubble!
	add-resetting-when-leave-apb!
	s3-robot-click-buttons-at-the-same-time-then-click-bubble!