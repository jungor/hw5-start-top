$ ->
  robot.init!
  handle-buttons !-> robot.click-all-buttons!
  handle-cumulator!
...
handle-cumulator = ->
  ...
  Button.fetch-all-random-numbers-done = !-> infobar.remove-class 'disabled'; infobar.add-class 'enabled'; infobar.click!
...
robot-click-from-A-to-E = !-> $ '#button .apb' .click !-> robot.click-all-buttons!;
